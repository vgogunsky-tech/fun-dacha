-- Essential OpenCart Migration SQL
-- This file contains only the essential data for standard OpenCart tables
-- Import this into your MySQL database at localhost:8082

-- Set database
USE opencart;

-- Clear existing data (only for tables that should exist)
