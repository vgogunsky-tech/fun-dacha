-- Bare Minimum OpenCart Migration SQL
...
-- Insert categories (bare minimum structure - only essential columns)
...
-- Insert sample products (bare minimum structure - only essential columns)
